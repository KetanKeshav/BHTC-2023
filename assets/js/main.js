...
(function() {
  ...
  window.addEventListener('load', () => {
    ...
    if (publicationContainer) {
      ...
      let publicationFilters = select('#publication-flters li', true);

      on('click', '#publication-flters li', function(e) {
        e.preventDefault();
  ...
  /**
   * publication details slider
   */
  new Swiper('.publication-details-slider', {
    speed: 400,
    loop: true,
    autoplay: {
      delay: 5000,
